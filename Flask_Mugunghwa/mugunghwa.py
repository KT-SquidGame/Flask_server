...
#     while True:
#         now = time.time()
#         cv2.putText(white_img, now, (10, 30),cv2.FONT_HERSHEY_PLAIN, 2, (255,255,255), 2)
#         ret, buffer = cv2.imencode('.jpg', white_img)
    ...
    while True:
        ...
        if not success:
            ...
            if tmp < 0:
                ...
                cv2.putText(frame, 'finish! move frame count :' + str(result_score) + '[-> NOT BAD]', (10, 30),cv2.FONT_HERSHEY_PLAIN, 2.5, (255,255,255), 2)
            else:
                left_time = str(tmp)
